...
# Created 2026-03-17 13:57:45

CASEDIR="/glade/campaign/cesm/cesmdata/cseg/runs/cesm2_0/b.e30_alpha08k.B1850C_LTso.ne30_t232_wgx3.325"

/glade/work/hannay/cesm_tags/cesm3_0_alpha08k/cime/scripts/create_newcase --compset B1850C_LTso --res ne30pg3_t232_wg37 --case "${CASEDIR}" --run-unsupported --project 93300722
