...
subroutine zm_conv_readnl(nlfile)
   ...
   namelist /zmconv_nl/ zmconv_c0_lnd, zmconv_c0_ocn, zmconv_num_cin, &
                        ...
                        zmconv_tiedke_add, zmconv_capelmt, zmconv_parcel_pbl,zmconv_parcel_hscale, &                          
   ...
   call mpi_bcast(zmconv_pini_ke,           1, mpi_real8, masterprocid, mpicom, ierr)   
   if (ierr /= 0) call endrun("zm_conv_readnl: FATAL: mpi_bcast: zmconv_pini_ke")
   call mpi_bcast(zmconv_pe2ke_eff,         1, mpi_real8, masterprocid, mpicom, ierr)   
...
!REMOVECAM_END
   ...
   call zm_convr_run(ncol, pver, &
                    ...
                    rice(:ncol), lengath, scheme_name, errmsg, errflg,iulog)
