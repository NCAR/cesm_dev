...
module parameters_tunable
  ...
  subroutine set_default_parameters( &
    ...
    C6rt_Lscale0  = 18.1474_core_rknd     ! Damp C6rt as a fnct. of Lscale  [-]
    C6thl_Lscale0 = 18.1474_core_rknd     ! Damp C6thl as a fnct. of Lscale [-]
    ...
    a_const = 1.8_core_rknd ! Used in sfc_varnce_module.F90 to set surface values
    bv_efold = 5._core_rknd ! Control parameter for inverse e-folding of
