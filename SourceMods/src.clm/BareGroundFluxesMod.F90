...
!KO    ! Coefficients from Alduchov and Eskridge (1996) as used by Lawrence (2005) for Magnus dewpoint
!KO    ! equation over liquid
!KO    real(r8), parameter :: A1_liq = 17.625_r8                   ! [-]
!KO    real(r8), parameter :: B1_liq = 243.04_r8                   ! [degC]
!KO    real(r8), parameter :: C1_liq = 610.94_r8                   ! [Pa]
!KO    ! Coefficients from Alduchov and Eskridge (1996) for Magnus dewpoint equation over ice
!KO    real(r8), parameter :: A1_ice = 22.587_r8                   ! [-]
!KO    real(r8), parameter :: B1_ice = 273.86_r8                   ! [degC]
!KO    real(r8), parameter :: C1_ice = 611.21_r8                   ! [Pa]
    !------------------------------------------------------------------------------
...
!KO         ! Magnus expression for dew point
!KO         ! Equation (7) from Lawrence (2005)
!KO         if (t_grnd(c) < 0._r8) then ! ice coefficients
!KO            forc_dewpoint = B1_ice*log(forc_e/C1_ice) / (A1_ice - log(forc_e/C1_ice))
!KO         else                        ! liquid water coefficients
!KO            forc_dewpoint = B1_liq*log(forc_e/C1_liq) / (A1_liq - log(forc_e/C1_liq))
!KO         end if
!KO         forc_dewpoint = forc_dewpoint + tfrz
