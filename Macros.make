...
CFLAGS :=  -qno-opt-dynamic-align -fp-model precise -std=gnu99 -O2 -debug minimal -no-fma -restrict -qopt-report -march=core-avx2
...
CXX_LINKER := FORTRAN
FC_AUTO_R8 := -r8
FFLAGS :=  -O2 -debug minimal -no-fma -qno-opt-dynamic-align  -convert big_endian -assume byterecl -ftz -traceback -assume realloc_lhs -fp-model source -qopt-report -march=core-avx2
FFLAGS_NOOPT := -O0
FIXEDFLAGS := -fixed
FREEFLAGS := -free
MACRO_FILE := 
...
MPIFC := ftn
MPI_SERIAL_PATH := 
NETCDF_PATH := /glade/u/apps/derecho/24.12/spack/opt/spack/netcdf/4.9.2/cray-mpich/8.1.29/oneapi/2024.2.1/g6nu
PIO_FILESYSTEM_HINTS := lustre
PIO_INCDIR := /glade/u/apps/derecho/24.12/spack/opt/spack/parallelio/2.6.4/cray-mpich/8.1.29/oneapi/2024.2.1/fbh4/include
PIO_LIBDIR := /glade/u/apps/derecho/24.12/spack/opt/spack/parallelio/2.6.4/cray-mpich/8.1.29/oneapi/2024.2.1/fbh4/lib
...
ifeq "$(COMP_NAME)" "mom"
  ...
  FFLAGS :=  $(FC_AUTO_R8)  -O2 -debug minimal -no-fma -qno-opt-dynamic-align  -convert big_endian -assume byterecl -ftz -traceback -assume realloc_lhs -fp-model source -qopt-report -march=core-avx2
endif
ifeq "$(COMP_NAME)" "gptl"
...
ifeq "$(COMP_NAME)" "mpi-serial"
  CFLAGS :=  -qno-opt-dynamic-align -fp-model precise -std=gnu99 -O2 -debug minimal -no-fma -restrict -qopt-report -march=core-avx2 -std=c89 
endif
